...
Cts_avg, Cts_err
Cps_avg, Cps_err
Cps_est_avg, Cps_est_err
T_avg, T_err
P_avg, P_err
P_est_avg, P_est_err [estimated MOTOR torque]
omega [rad/s], motor
sigma
rho
R
...
Kt = StreamData.Kt; %Estimated torque constant based on 12/16/2021 tripod stand testing of Q-I Curve Fit
...
for i = 1:length(steady_test)
    ...
    Averages.cps_est_avg{i} = AvgData.avg_cps_est{idx_steady};
    Averages.cps_est_err{i} = AvgData.err_cps_est{idx_steady};
    ...
    Averages.P_err{i} = Averages.cps_err{i}*Averages.sigma*pi*Averages.R^2*....
        Averages.rho{i}*(Averages.OMEGA{i}*Averages.R)^3;
    Averages.P_est_avg{i} = Averages.cps_est_avg{i}*Averages.sigma*pi*Averages.R^2*....
        Averages.rho{i}*(Averages.OMEGA{i}*Averages.R)^3;
    Averages.P_est_err{i} = Averages.cps_est_err{i}*Averages.sigma*pi*Averages.R^2*....
        Averages.rho{i}*(Averages.OMEGA{i}*Averages.R)^3;
