...
%     StreamData.Fz_inner{i} = fcleanup(StreamData.Fz_inner{i},'smoothdata','loess',800);
    ...
    T_trans(:,i)   = abs(StreamData.Fz_inner{i}(idx_trig));
    T_trans(:,i)  = fcleanup(T_trans(:,i), 'smoothdata', 'loess', 300);
