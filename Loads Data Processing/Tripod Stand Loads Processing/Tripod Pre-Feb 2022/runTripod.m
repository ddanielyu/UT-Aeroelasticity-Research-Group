...
for i = 1:length(StreamData.names)
    ...
    if ismember(1,abs(StreamData.Mz_inner{i} - mean(StreamData.Mz_inner{i})) > Trig) && isempty(motors)
...
if exist('phaseSync_test','var'); [f5,f6] = plotPhaseSync(PhaseSync,phaseSync_test); end
